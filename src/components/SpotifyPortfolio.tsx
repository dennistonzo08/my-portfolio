...
export default function SpotifyPortfolio() {
  ...
  return (
    <div className="flex h-screen bg-black text-white overflow-hidden">
      {/* Sidebar */}
      <div className="w-64 bg-black p-6 flex flex-col border-r border-zinc-800">
        <div className="mb-8">
      ...
      <div className="flex-1 overflow-y-auto bg-gradient-to-b from-zinc-900 to-black">
        {activeSection === 'home' && (
          <div className="p-8">
            <div className="bg-gradient-to-r from-green-900 to-zinc-900 rounded-lg p-12 mb-8">
              <div className="flex items-center gap-8">
                <img
                  src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?w=200&h=200&fit=crop"
                  alt="Profile"
                  className="w-40 h-40 rounded-full border-4 border-green-500 shadow-2xl"
                />
                <div>
                  <p className="text-sm font-semibold mb-2">DEVELOPER</p>
                  <h1 className="text-6xl font-bold mb-4">Your Name</h1>
                  <p className="text-lg text-gray-300 mb-4">Full Stack Developer | React Specialist</p>
        ...
        {activeSection === 'about' && (
          <div className="p-8">
            <div className="bg-gradient-to-r from-purple-900 to-zinc-900 rounded-lg p-12 mb-8">
              <h1 className="text-5xl font-bold mb-4">About Me</h1>
              <p className="text-xl text-gray-300">Passionate Developer & Problem Solver</p>
            </div>
        ...
        {activeSection === 'projects' && (
          <div className="p-8">
            <div className="bg-gradient-to-r from-blue-900 to-zinc-900 rounded-lg p-12 mb-8">
              <h1 className="text-5xl font-bold mb-4">My Projects</h1>
              <p className="text-xl text-gray-300">Showcasing my best work</p>
            </div>
        ...
        {activeSection === 'skills' && (
          <div className="p-8">
            <div className="bg-gradient-to-r from-red-900 to-zinc-900 rounded-lg p-12 mb-8">
